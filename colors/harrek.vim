...
if &background == "light"
  ...
  highlight NormalFloat  ctermfg=7    ctermbg=0    cterm=bold
endif
...
highlight CmpItemMenu ctermfg=0 ctermbg=NONE
highlight WhichKey ctermfg=1
highlight WhichKeyFloat ctermbg=0
highlight WhichKeyDesc ctermfg=1
